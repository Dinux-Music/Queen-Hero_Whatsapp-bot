...
XeonBotInc.sendMessage(m.chat, { react: { text: '🧼', key: m.key }})
  if (!text) return reply( `Example : ${prefix + command} link`)
    ...
    const sdfbdown = await XeonBotInc.sendMessage(m.chat , { text: '𝚞𝚙𝚕𝚘𝚍𝚒𝚗𝚐 𝚋𝚢 Qᴜᴇᴇɴ ʜᴇʀᴏ' }, { quoted: m } )
    await XeonBotInc.sendMessage(m.chat, { delete: sdfbdown.key })
    const sdfbup = await XeonBotInc.sendMessage(m.chat , { text: '𝚞𝚙𝚕𝚘𝚍𝚒𝚗𝚐 𝚋𝚢 Qᴜᴇᴇɴ ʜᴇʀᴏ' }, { quoted: m } )
    let host = `https://api.akuari.my.id/downloader/fbdl?link=${text}`;
    axios.get(host)
        .then(({ data }) => {
XeonBotInc.sendMessage(m.chat, { video: { url: data.url.url }, caption: '𝚞𝚙𝚕𝚘𝚍𝚒𝚗𝚐 𝚋𝚢 Qᴜᴇᴇɴ ʜᴇʀᴏ'}, { quoted: m })})
...
break
             ...
             break
                ...
                case 'video': { 
                    ...
                    caption: `Qᴜᴇᴇɴ ʜᴇʀᴏ ᴠɪᴅᴇᴏ ᴅᴏᴡɴʟᴏᴀᴅᴇʀ
...
ʀᴜɴᴛɪᴍᴇ : ${runtime(process.uptime())}`,
                    footer: `Qᴜᴇᴇɴ ʜᴇʀᴏ ᴡʜᴀᴛꜱᴀᴘᴘ ʙᴏᴛ`,
                    buttons: buttons,
                    headerType: 4,
                    }
                    ...
                    let buttonMessage = {
                    image: { url: anulay.thumbnail },
                    caption: `Qᴜᴇᴇɴ ʜᴇʀᴏ ꜱᴏɴɢ ᴅᴏᴡɴʟᴏᴀᴅᴇʀ
...
ʀᴜɴᴛɪᴍᴇ : ${runtime(process.uptime())}`,
                    footer: `Qᴜᴇᴇɴ ʜᴇʀᴏ ᴡʜᴀᴛꜱᴀᴘᴘ ᴜꜱᴇʀ ʙᴏᴛ`,
                    buttons: buttons,
                    headerType: 4
                    }
                    XeonBotInc.sendMessage(m.chat, buttonMessage, { quoted: m })
